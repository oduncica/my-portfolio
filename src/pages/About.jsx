      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
        ...
        <div>
          ...
          <p className="text-gray-300 mb-6 leading-relaxed">
            Étudiante en Master Systèmes d’information à Paris Dauphine, je suis
            passionnée par les technologies IT et la transformation numérique.
          </p>
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2 text-gray-400 list-disc list-inside">
            ...
            <li>React, Node.js, HTML/CSS, JavaScript</li>
